"""Frozen v0 Requirement Graph builder (pre-2026-08-13 revision).

This module is byte-for-byte the deterministic builder used to produce the
original extraction-time Requirement Graphs (before the or/and single-child
and leaf-coverage fixes). It is kept read-only so the original prediction
graphs can be reproduced exactly; new development lives in
...
BUILDER_IDENTITY = "requirement-graph.v0-frozen-2026-08-13"
