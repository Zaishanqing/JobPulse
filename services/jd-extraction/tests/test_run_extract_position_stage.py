...
def test_run_position_classification_targets_only_current_run(
    ...
    run_dir = tmp_path / "runs" / "sample_b001"
    ...
    assert position_args.checkpoint.name == "sample_b001.checkpoint.json"
    assert output == tmp_path / "runs_position_v3" / "sample_b001_position_v3"
