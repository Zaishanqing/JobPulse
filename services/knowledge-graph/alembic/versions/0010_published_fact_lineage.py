"""persist immutable validation and catalog lineage for published facts

Revision ID: 0010_published_fact_lineage
Revises: 0009_authoritative_published_facts
"""
...
revision = "0010_published_fact_lineage"
down_revision = "0009_authoritative_published_facts"
branch_labels = None
depends_on = None
...
def downgrade():
    raise RuntimeError("Migration 0010 is forward-only and cannot be downgraded")
